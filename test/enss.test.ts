...
describe("ENSS", () => {
  describe.each([
    ...
    test("element conditional classes", () => {
      ...
      expect(en.part.adrift() /*----------*/).toBe(
        "Ship-part Ship-part--adrift"
      );
      expect(en.part.adrift(true) /*------*/).toBe(
        "Ship-part Ship-part--adrift"
      );
      ...
      expect(en.Ship.part.adrift.s /*-----*/).toBe(
        "Ship-part Ship-part--adrift"
      );
      expect(en.Ship.part.adrift() /*-----*/).toBe(
        "Ship-part Ship-part--adrift"
      );
      expect(en.Ship.part.adrift(true) /*-*/).toBe(
        "Ship-part Ship-part--adrift"
      );
  ...
  describe.each([
    ...
    (_, Name, Elem, Cond, NameMapped, ElemMapped, CondMapped) => {
      ...
      test("enum values with class composition", () => {
        ...
        expect(en(en.warp(true), en.adrift(false))).toBe(
        ...
        expect(en({ warp: true, adrift: false })).toBe(
          "Ship Ship--warp abc jkl"
        );
        ...
        expect(en.part(en.warp(0), en.adrift("at space"))).toBe(
          "Ship-part ghi"
        );
        // all non-bool values ignored unless config.strictBoolChecks=false
  ...
  describe.each([
    ...
    (_, Name, Elem, Cond, NameMapped, ElemMapped, CondMapped) => {
      ...
      test("omit elements", () => {
        ...
        expect(en.warp.s /*-------------*/).toBe("Ship Ship--warp abc jkl");
        expect(en.warp() /*-------------*/).toBe("Ship Ship--warp abc jkl");
        expect(en.adrift(true) /*-------*/).toBe("Ship Ship--adrift abc mno");
        expect(en.adrift(false) /*------*/).toBe("Ship abc");

        expect(en.Ship.warp.s /*--------*/).toBe("Ship Ship--warp abc jkl");
        expect(en.Ship.warp() /*--------*/).toBe("Ship Ship--warp abc jkl");
        expect(en.Ship.adrift(true) /*--*/).toBe("Ship Ship--adrift abc mno");
